...
const Testimonial = () => {
   const [Testimonial_Image, setTestimonial_Image] =
      React.useState(null);
      ...
      <div className='w-screen bg-[#f0edede7] flex items-center justify-center py-[5vh]'>
         ...
         >
            <div className='Title p-3 border-b-2 border-[#D1D5DB]'>
               <h1 className='text-[1.5vw] font-bold text-[#1F2937]'>
                  Submit Testimonial
               </h1>
            </div>
            <div className='bg-[#F9FAFB] mb-[7vh] inner-form w-full flex flex-col items-center gap-6 p-[2vw] rounded-md border-[1px]'>
               <div className='Image_Container flex flex-col items-center gap-2'>
                  ...
                  >
                     <img
                        src={
                           Testimonial_Image ||
                           'https://ui-avatars.com/api/?name=Testimonial&background=eee&color=555'
                        }
                        alt='Testimonial'
               ...
               <div className='w-full flex flex-col gap-4'>
                  <label
                     ...
                     className='font-medium text-[1rem] mb-1 text-gray-700'
                  >
                     Name
                  </label>
                  <input
                  ...
                  <label
                     ...
                     className='font-medium text-[1rem] text-gray-700 mb-1'
                  >
                     Email
                  </label>
                  <input
